...
Ans: the fit is fairly accurate, 

- Comment on the prediction; does it seem reasonable?

(1) they’re somewhat symmetrically distributed, tending to cluster towards the middle of the plot.
(2) they’re clustered around the lower single digits of the y-axis.
(3) in general, there is a blur pattern.
